...
.ORIG x3000
LEA    R1,INPUT
LDW    R1, R1, #0         ; R1 contains input number
LEA    R2, THIRDNUM
LDW    R2, R2, #0         ; R2 contains -1
